...
class RegisterActivity : AppCompatActivity() {
    ...
    */
    ...
    private fun register(){
        ...
        if(isValidFrom(name= name ,phone = phone, lastname = lastname, email = email , password = password, confirmPassword = confirmPassword)) {
...
//Mandamos  que una vez registrado se vaya a seleccionar una imagen o foto de usuario y esta se almacena en firebase
    ...
    private fun isValidFrom(
        ...
        if(confirmPassword.isBlank()){
            Toast.makeText(this, "Debes ingresar el la confirmacion de la contraseña", Toast.LENGTH_SHORT).show()
            return false
        }
