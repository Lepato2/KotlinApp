package com.optic.kotlinudemydelivery.activities.pedidos.home
...
class PedidosHomeActivity : AppCompatActivity() {

    private val TAG = "PedidosHomeActivity"
...
//        buttonLogout?.setOnClickListener { logout() }
        ...
        openFragment(EmpresaOrdersFragment())
        ...
        bottomNavigation?.setOnItemSelectedListener {
            ...
            when(it.itemId){
                ...
                R.id.item_category ->{
                    openFragment(EmpresaCategoryFragment())
                    true
                }
                R.id.item_product ->{
                    openFragment(EmpresaProductFragment())
                    true
                }
                R.id.item_profile ->{
